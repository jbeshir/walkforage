/**
 * processEcoregionsShapefile.mjs - Process Resolve Ecoregions shapefile directly
 *
 * Reads the shapefile feature by feature and builds a geohash-indexed biome database.
 * More memory efficient than converting to GeoJSON first.
 *
 * Usage: node scripts/gis/processEcoregionsShapefile.mjs
 *
